 ...
 *
 */
// 17-1 : Make DessertTimer a LifecycleObserver
// Note :  implement a LifecycleObserver,
// take in a Lifecycle as a parameter and
// establish observer relationship in init block
class DessertTimer(lifecycle: Lifecycle) : LifecycleObserver {
    ...
    // 17-2 : Annotate startTimer and stopTimber with @OnLifecycleEvent and the correct event
